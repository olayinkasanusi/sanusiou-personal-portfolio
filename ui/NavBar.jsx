...
function Navbar() {
  return (
    <div className="rounded-full w-1/2 mx-auto mt-2 shadow-lg bg-[#0A192F] shadow-blue-400 flex justify-between items-center px-6 py-2  border-2 border-blue-600 z-100 ">
